...
use Elixant\Components\Utility\Traits\Macroable;
...
class Str
{
	...
	protected static function charsArray()
	{
		...
		return $charsArray = [
			...
			'r'    => ['ŕ', 'ř', 'ŗ', 'р', 'ρ', 'ر', 'რ', 'ｒ'],
			's'    => [
				'ś', 'š', 'ş', 'с', 'σ', 'ș', 'ς', 'س', 'ص', 'စ', 'ſ',
				'ს', 'ｓ',
			],
			't'    => [
				'ť', 'ţ', 'т', 'τ', 'ț', 'ت', 'ط', 'ဋ', 'တ', 'ŧ', 'თ',
				'ტ', 'ｔ',
			],
			'u'    => [
